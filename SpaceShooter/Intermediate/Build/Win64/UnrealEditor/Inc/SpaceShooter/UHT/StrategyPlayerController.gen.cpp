...
SPACESHOOTER_API UClass* Z_Construct_UClass_AStrategyPlayerController();
SPACESHOOTER_API UClass* Z_Construct_UClass_AStrategyPlayerController_NoRegister();
SPACESHOOTER_API UClass* Z_Construct_UClass_AStrategyUnit_NoRegister();
SPACESHOOTER_API UEnum* Z_Construct_UEnum_SpaceShooter_EStrategyInputMode();
...
static UEnum* EStrategyInputMode_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SpaceShooter_EStrategyInputMode, (UObject*)Z_Construct_UPackage__Script_SpaceShooter(), TEXT("EStrategyInputMode"));
	}
	return Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton;
}
template<> SPACESHOOTER_API UEnum* StaticEnum<EStrategyInputMode>()
{
	return EStrategyInputMode_StaticEnum();
}
struct Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_SpaceShooter,
	nullptr,
	"EStrategyInputMode",
	"EStrategyInputMode",
	Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_SpaceShooter_EStrategyInputMode()
{
	if (!Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton, Z_Construct_UEnum_SpaceShooter_EStrategyInputMode_Statics::EnumParams);
	}
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, InputMode), Z_Construct_UEnum_SpaceShooter_EStrategyInputMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputMode_MetaData), NewProp_InputMode_MetaData) }; // 1682242233
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_Strategy_StrategyPlayerController_h__Script_SpaceShooter_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStrategyInputMode_StaticEnum, TEXT("EStrategyInputMode"), &Z_Registration_Info_UEnum_EStrategyInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1682242233U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrategyPlayerController, AStrategyPlayerController::StaticClass, TEXT("AStrategyPlayerController"), &Z_Registration_Info_UClass_AStrategyPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrategyPlayerController), 323892387U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_Strategy_StrategyPlayerController_h__Script_SpaceShooter_425851004(TEXT("/Script/SpaceShooter"),
	Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_Strategy_StrategyPlayerController_h__Script_SpaceShooter_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_Strategy_StrategyPlayerController_h__Script_SpaceShooter_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_Strategy_StrategyPlayerController_h__Script_SpaceShooter_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_Strategy_StrategyPlayerController_h__Script_SpaceShooter_Statics::EnumInfo));
// ********** End Registration *********************************************************************
