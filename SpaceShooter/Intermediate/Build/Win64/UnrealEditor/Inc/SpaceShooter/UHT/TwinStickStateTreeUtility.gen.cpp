...
SPACESHOOTER_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
SPACESHOOTER_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_SpaceShooter(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_SpaceShooter(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_SpaceShooter_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 2606495555U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 3452126907U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_SpaceShooter_3434804566(TEXT("/Script/SpaceShooter"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_SpaceShooter_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SpaceShooter_SpaceShooter_Source_SpaceShooter_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_SpaceShooter_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
